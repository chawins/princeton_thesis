...
def experiment(mod, weight_path):
    ...
    pickle.dump(out_all, open(path + 'adv_acc_cw_a_c1e2_os.p', 'wb'))
    pickle.dump(adv_all, open(path + 'norm_cw_a_c1e2_os.p', 'wb'))
...
for m in ['a']:
    ...
    for L in ['1e-1', '1', '1e1']:
        ...
        weight_path = './tmp/mnist_{}_margin_c1e2_l{}/model.h5'.format(m, L)
